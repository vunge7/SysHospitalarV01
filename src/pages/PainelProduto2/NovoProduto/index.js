...
const NovoProduto = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const dataToSubmit = { ...{}, status: true, productType: t, productGroup: g, preco: p, taxIva: i, productNumberCode: nc, productDescription: d, productCode: c };
